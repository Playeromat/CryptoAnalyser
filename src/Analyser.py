...
class Analyser:
    ...
    def get_user_selections(self):
        self.markets = [*self.binance_controller.get_markets()]
        self.timeframes = [*self.binance_controller.get_timeframes()]
    ...
    def get_candle_data(self):
        for user_input_market in self.user_input_markets:
            for user_input_timeframe in self.user_input_timeframes:
                self.binance_controller.fetch_data(self.markets[user_input_market], self.timeframes[user_input_timeframe])

        self.db_controller.add_entries(self.binance_controller.candles)
